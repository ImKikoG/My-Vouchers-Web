    ...
    <div>
      <div class="split left">
        <table class="admin_table">
          ...
          <tr>
            <td className="admin_list">&emsp;Student 1</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 2</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 3</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 4</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 5</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 6</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 7</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 8</td>
          </tr>
          <tr>
            <td className="admin_list">&emsp;Student 9</td>
          </tr>
        </table>
      </div>
